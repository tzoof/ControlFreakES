...
class GameFitness(Fitness):
    ...
    def __init__(self, game_name, num_layers, layers_output_sizes_but_last, episodes_per_fitness=1):
        ...
        self.policy = PolicyNetwork(self.inputSize, self.num_layers, self.layers_output_sizes, self._game_name)
...
if __name__ == "__main__":
    # test_model(log_dir="logs\GameFitness_MountainCar-v0_2020-01-09-21-06-centroid_0_sigma_50_ngen_300_best",
    #                game_name="MountainCar-v0", episodes=100, render_val=False)
    # test_model(log_dir="logs\GameFitness_MountainCar-v0_2020-01-10-12-51-centroid_0_sigma_20_ngen_500_best2",
    #                game_name="MountainCar-v0", episodes=100, render_val=False)
    # test_model(log_dir="logs\GameFitness_MountainCar-v0_2020-01-10-13-43-centroid_0_sigma_20_ngen_5000",
    #                game_name="MountainCar-v0", episodes=100, render_val=False)
    # test_model(log_dir="logs\GameFitness_MountainCar-v0_2020-01-10-13-43-centroid_0_sigma_50_ngen_5000",
    #                game_name="MountainCar-v0", episodes=100, render_val=False)

    #test_model(log_dir="logs\GameFitness_CartPole-v0_2020-01-08-16-37-3Episodes-400gens",
    #               game_name="CartPole-v0", episodes=100, render_val=False)

    #test_model(log_dir="logs\GameFitness_Acrobot-v1_2020-01-06-01-07-1Episode--1000gens",
    #               game_name="Acrobot-v1", episodes=100, render_val=False)
